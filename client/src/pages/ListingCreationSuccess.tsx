...
const ListingCreationSuccessPage = () => {
    return (
                    ...
                    <div className="col-md-8 col-lg-6">
                        <div className="card border-0 shadow-lg text-center p-5">
                            <div className="mb-4">
                                ...
                                <h1 className="display-5 fw-bold mb-3">Success!</h1>
                                <p className="text-muted mb-4">
                                    Your listing has been created successfully and is now visible to potential roommates.
                                </p>
                            </div>
...
export default ListingCreationSuccessPage;
